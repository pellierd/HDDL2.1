...
This paper proposes a BNF syntax to extend HDDL to deal with time and numeric. The proposed syntax, called HDDL2.1, takes its roots in HDDL~\citep{holler:19}. 
