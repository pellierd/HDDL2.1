...
In fact, many applications require features that have been (on purpose) omitted in this paper. Most importantly, we didn't explicitely reported a syntax for constraints on solution plans, e.g. to put a max time limit, and we didn't allowed to define delays  with point algebra for ordering constraints. Other aspects are simply not detailed here, e.g. continuous effects.
